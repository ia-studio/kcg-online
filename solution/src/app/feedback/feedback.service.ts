...
export class FeedbackService {
  public mock = false;
  private pointFeedbackUrl = this.mock ? 'assets/pointFeedback.json' : '/webapi/api/satPool/1';
  private countFeedbackUrl = this.mock ? 'assets/countFeedback.json' : '/webapi/api/satPool/2';
  private effectiveFeedbackUrl = this.mock ? 'assets/effectiveFeedback.json' : '/webapi/api/satPool/3';
